    ...
    return(
        <>
            ...
            <div className="w-full">
                ...
                <div className="flex gap-2 text-gray-400">
                    <div>
                        ...
                        <div className="w-full bg-white rounded-md flex  justify-between px-2 my-2 items-center shadow-md">
                            ...
                            <input type="text" className="py-2 w-[100%] bg-white outline-none" placeholder="Email"/>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="w-full bg-white rounded-md flex  justify-between px-2 my-2 items-center shadow-md">
                            ...
                            <input type="text" className="py-2 w-[100%] bg-white outline-none" placeholder="Username"/>
                        </div>
                    </div>
                </div>
                ...
                <p className="w-full text-center text-xl my-12 py-2 rounded-full hover:bg-rose-600 shadow-md bg-honey cursor-pointer text-black tracking-wider">Sign Up</p>
