...
export default function DrawerMain({setDisplay}){
    return(
        <>
        <p className="flex items-center text-2xl text-black font-bold w-full hover:bg-olive transition-all ease-linear cursor-pointer duration-75 px-4 py-2" onClick={()=>setDisplay(false)}>Categories
        ...
        <p className="w-full h-[0.5px] my-2 bg-olive"></p>
